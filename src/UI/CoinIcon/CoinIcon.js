...
import currencyAcronyms from "../../assets/currencyAcronyms";

const Icon = createIconSetFromFontello(fontelloConfig);

const CoinIcon = props => {
  let acronym = currencyAcronyms.find(name => {
    return name === props.coinSymbol.toLowerCase();
  });

  return (
    <Icon {...props} name={acronym ? acronym : "kin"} />
  );
};
...
//   let acronym = currencyAcronyms.find(name => {
//     return name === props.coinImage.toLowerCase();
//   });

//   let currencyIcon = (
//     <Icon name={acronym ? acronym : "kin"} size={30} color="#8ee4af" />
//   );
